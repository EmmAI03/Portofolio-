...
// OGL App classes (Title, Media, App) from the provided code
class Title {
...
export default function ProjectsGallery({
  items, bend = 3, textColor = "#334155", borderRadius = 0.07, font = "bold 24px 'Inter', sans-serif", scrollSpeed = 2, scrollEase = 0.05,
}) {
