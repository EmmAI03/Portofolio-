            ...
            >
                ...
                >
                    <a 
                        ...
                        download
                        className="bg-blue-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-blue-700 transition-all transform hover:scale-105 shadow-lg flex items-center justify-center gap-2"
                    >
                    ...
                    <a 
                        ...
                        className="border-2 border-slate-400 text-slate-700 px-6 py-3 rounded-lg font-semibold hover:bg-slate-100 hover:border-blue-600 transition-all transform hover:scale-105 flex items-center justify-center gap-2"
                    >
            ...
            >
                ...
                >
                    ...
                    <img 
                        ...
                        className="relative w-full h-full object-cover rounded-full shadow-2xl border-4 border-white object-top" 
                    />
                </motion.div>
            </motion.div>
        </div>
