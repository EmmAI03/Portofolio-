...
const Footer = () => {
    ...
    return (
        // Mengubah background menjadi terang dengan efek glassmorphism
        <footer className="bg-white/70 backdrop-blur-sm text-slate-700 pt-16 pb-8">
            <div className="container mx-auto px-6">
                <div className="grid md:grid-cols-3 gap-12">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            {navLinks.map(link => (
                                <li key={link}>
                                    <a href={`#${link.toLowerCase()}`} className="text-slate-600 hover:text-blue-600 transition-colors">
                                        {link}
                                    </a>
                                </li>
                            ))}
                ...
                <div className="mt-16 pt-8 border-t border-slate-200 text-center text-slate-500 text-sm">
                    <p>&copy; {new Date().getFullYear()} Emmy Rahmaniasari. All Rights Reserved.</p>
